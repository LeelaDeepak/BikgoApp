...
class RenterBikeRCUpload extends StatefulWidget {
  const RenterBikeRCUpload({Key? key}) : super(key: key);

  @override
  State<RenterBikeRCUpload> createState() => _RenterBikeRCUploadState();
}

class _RenterBikeRCUploadState extends State<RenterBikeRCUpload> {
  PlatformFile? pickedFile;
  UploadTask? uploadTask;

  Future uploadFile(context) async {
    if (pickedFile != null) {
      final path = "Renter/Bike-RC/$globalUseremail/${pickedFile!.name}";
      final file = File(pickedFile!.path!);
      RenterkaRCfilename = pickedFile!.name;
      print(Renterkanaam);
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Row(
          ...
          children: const [
            ...
            SizedBox(width: 16),
            Expanded(
                child: Text('The Bike-RC PDF has been uploaded successfully.',
                    style: TextStyle(
                      fontSize: 20,
                    )))
          ],
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (isrenterRCuploaded == 1) {
                          setState(() {
                            onbtnrenterenabled1 = false;
                            uploadrentervalueoffirst += 1;
                          });
