...
class RenterBikePhoto extends StatefulWidget {
  const RenterBikePhoto({Key? key}) : super(key: key);

  @override
  State<RenterBikePhoto> createState() => _RenterBikePhotoState();
}

class _RenterBikePhotoState extends State<RenterBikePhoto> {
