...
class RenterBikePhotoUpdate extends StatefulWidget {
  const RenterBikePhotoUpdate({Key? key}) : super(key: key);

  @override
  State<RenterBikePhotoUpdate> createState() => _RenterBikePhotoUpdateState();
}

class _RenterBikePhotoUpdateState extends State<RenterBikePhotoUpdate> {
  ...
  Future uploadFile(context) async {
    if (pickedFile != null) {
      final path =
          "Renter/Renter_Bike_Photo/$globalUseremail/${pickedFile!.name}";
      final file = File(pickedFile!.path!);
      RenterkaBikephotofilename = pickedFile!.name;
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Row(
          ...
          children: const [
            ...
            SizedBox(width: 16),
            Expanded(
                child: Text('The Bike photo has been uploaded successfully.',
                    style: TextStyle(
                      fontSize: 20,
                    )))
          ],
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (isrenterbikephotouploaded == 1) {
                          setState(() {
                            onbtnrenterenabled4 = false;
                            uploadrentervalueoffour += 1;
                          });
                          Navigator.pushNamed(
