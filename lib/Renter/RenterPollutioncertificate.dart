...
class RenterPollutioncertificate extends StatefulWidget {
  const RenterPollutioncertificate({Key? key}) : super(key: key);

  @override
  State<RenterPollutioncertificate> createState() =>
      _RenterPollutioncertificateState();
}

class _RenterPollutioncertificateState
    extends State<RenterPollutioncertificate> {
  ...
  Future uploadFile(context) async {
    if (pickedFile != null) {
      final path =
          "Renter/Bike-PollutionCertificate/$globalUseremail/${pickedFile!.name}";
      final file = File(pickedFile!.path!);
      RenterkaPollutionfilename = pickedFile!.name;
      ...
      setState(() {
        ...
        isriderbikepollutioncertificateuploaded = 1;
      });
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Row(
          ...
          children: const [
            ...
            Expanded(
                child: Text(
                    'The Pollution Certificate-PDF has been uploaded successfully.',
                    style: TextStyle(
                      fontSize: 20,
                    )))
          ],
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (isriderbikepollutioncertificateuploaded == 1) {
                          setState(() {
                            onbtnrenterenabled3 = false;
                            uploadrentervalueofthree += 1;
                          });
