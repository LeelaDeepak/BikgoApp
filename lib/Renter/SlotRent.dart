...
class SlotRent extends StatefulWidget {
  const SlotRent({Key? key}) : super(key: key);

  @override
  State<SlotRent> createState() => _SlotRentState();
}

class _SlotRentState extends State<SlotRent> {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Row(
                            ...
                            children: const [
                              ...
                              Expanded(
                                  child: Text(
                                      'Your Slot Has Been Booked For Rental!',
                                      style: TextStyle(
                                        fontSize: 20,
                                      )))
                            ],
