...
class RiderFrontLicense extends StatefulWidget {
  const RiderFrontLicense({Key? key}) : super(key: key);

  @override
  State<RiderFrontLicense> createState() => _RiderFrontLicenseState();
}

class _RiderFrontLicenseState extends State<RiderFrontLicense> {
