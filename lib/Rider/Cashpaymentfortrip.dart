...
class Cashpaymentbyrider extends StatefulWidget {
  const Cashpaymentbyrider({Key? key}) : super(key: key);

  @override
  State<Cashpaymentbyrider> createState() => _CashpaymentbyriderState();
}

class _CashpaymentbyriderState extends State<Cashpaymentbyrider> {
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      if (cashController.text != "") {
                        if (cashController.text == rentamount) {
