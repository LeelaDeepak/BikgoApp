...
class RiderUpdatSelfie extends StatefulWidget {
  const RiderUpdatSelfie({Key? key}) : super(key: key);

  @override
  State<RiderUpdatSelfie> createState() => _RiderUpdatSelfieState();
}

class _RiderUpdatSelfieState extends State<RiderUpdatSelfie> {
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (riderselfieuploaded == 1) {
                          ...
                          Navigator.pushNamed(context, 'RiderUpdatePhotos.id');
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
