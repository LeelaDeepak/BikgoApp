...
class RiderUpdateBackLicense extends StatefulWidget {
  const RiderUpdateBackLicense({Key? key}) : super(key: key);

  @override
  State<RiderUpdateBackLicense> createState() => _RiderUpdateBackLicenseState();
}

class _RiderUpdateBackLicenseState extends State<RiderUpdateBackLicense> {
  ...
  Future uploadFile(context) async {
    if (pickedFile != null) {
      final path =
          "Rider/Vechile-License/$globalUseremail/Back_Rider_License/${pickedFile!.name}";
      final file = File(pickedFile!.path!);
      BackSideLicense = pickedFile!.name;
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Row(
          ...
          children: const [
            ...
            Expanded(
                child: Text(
                    'The License-Back side photo has been uploaded successfully.',
                    style: TextStyle(
                      fontSize: 20,
                    )))
          ],
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (riderlicenceback == 1) {
                            setState(() {
                              onbtnenabled2 = false;
                              uploadvalueofsecond += 1;
                            });
                            Navigator.pushNamed(
