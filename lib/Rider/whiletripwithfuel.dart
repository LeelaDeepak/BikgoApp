...
class Whietripwithfuel extends StatefulWidget {
  const Whietripwithfuel({Key? key}) : super(key: key);

  @override
  State<Whietripwithfuel> createState() => _WhietripwithfuelState();
}

class _WhietripwithfuelState extends State<Whietripwithfuel> {
            ...
            SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ...
                    Navigator.pushNamed(context, 'tripbillforisfuel.id');
                  },
                )),
            const SizedBox(
              height: 30,
